use crate::actor::{
    ActorIsolationEnvironment, ActorIsolationExecutorContext, ActorIsolationExecutorReceiveState,
    ActorIsolationExecutorState, ActorIsolationExecutorStateHandler, ActorRootEnvironment,
};
use alloc::boxed::Box;
use core::arch::asm;
...
#[derive(Constructor)]
pub struct ActorIsolationExecutorCreateState<AI, AR, H>
where
...
impl<AI, AR, H> ActorIsolationExecutorCreateState<AI, AR, H>
where
    AI: Actor<ActorIsolationEnvironment>,
    AR: Actor<ActorRootEnvironment<H>>,
    H: FutureRuntimeHandler,
...
impl<AI, AR, H> ActorIsolationExecutorStateHandler<AI, AR, H>
    for ActorIsolationExecutorCreateState<AI, AR, H>
where
    AI: Actor<ActorIsolationEnvironment>,
    AR: Actor<ActorRootEnvironment<H>>,
    H: FutureRuntimeHandler,
{
    ...
    fn next_state(self) -> Option<ActorIsolationExecutorState<AI, AR, H>> {
        Some(ActorIsolationExecutorReceiveState::new(self.actor).into())
    }
}
